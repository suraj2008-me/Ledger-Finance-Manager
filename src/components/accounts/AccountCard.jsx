import { Pencil, Trash2, Landmark, Wallet, CreditCard, PiggyBank, TrendingUp, Circle } from 'lucide-react'
    ...
    <div className="group flex items-center justify-between border-b border-hairline dark:border-hairline-dark py-4 last:border-b-0">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-ink-400 capitalize">{account.type.replace('_', ' ')}</p>
        </div>
      </div>
      <div className="flex items-center gap-3">
        <span
