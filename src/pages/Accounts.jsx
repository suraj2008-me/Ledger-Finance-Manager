    ...
    <AppShell title="Accounts">
      <div className="">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-lg text-ink-900 dark:text-paper">Your accounts</h2>
          <Button
            size="sm"
            onClick={() => {
              setEditing(null)
      ...
      <AccountModal
        ...
        onSave={(payload) => (editing ? updateAccount(editing.id, payload) : addAccount(payload))}
        initial={editing}
      />
      <ConfirmDialog
        open={!!toDelete}
