  ...
  return (
    <AppShell title="Settings">
      <div className="space-y-8">
        <section>
          <h2 className="mb-4 font-display text-lg text-ink-900 dark:text-paper">Profile</h2>
          <form onSubmit={onSave} className="space-y-4 rounded-md border border-hairline dark:border-hairline-dark p-6">
        ...
        <section>
          <h2 className="mb-4 font-display text-lg text-ink-900 dark:text-paper">Appearance</h2>
          <div className="flex items-center justify-between rounded-md border border-hairline dark:border-hairline-dark p-6">
            <div>
              ...
              <p className="text-xs text-ink-400">Switch between light and dark ledger themes.</p>
            </div>
        ...
        <section>
          <h2 className="mb-4 font-display text-lg text-ink-900 dark:text-paper">Your data</h2>
          <div className="flex items-center justify-between rounded-md border border-hairline dark:border-hairline-dark p-6">
            <div>
              <p className="text-sm text-ink-900 dark:text-paper">Export everything</p>
            ...
            <Button
              variant="secondary"
              size="sm"
              onClick={() => downloadCSV('ledgerly-all-data.csv', transactionsToCSV(transactions))}
            >
              Export CSV
            </Button>
          </div>
        ...
        <section>
          ...
          <div className="flex items-center justify-between rounded-md border border-hairline dark:border-hairline-dark p-6">
            <div>
              ...
              <p className="text-xs text-ink-400">End your session on this device.</p>
            </div>
